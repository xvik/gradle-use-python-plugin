...
class CliUtilsTest extends Specification {
    ...
    def "Check credentials cleanup"() {
        ...
        '-m pip something --index-url http://user:pass@some-url.com'                                                                | '-m pip something --index-url http://user:*****@some-url.com'
        '-m pip something --extra-index-url  http://user:pass@some-url.com'                                                         | '-m pip something --extra-index-url  http://user:*****@some-url.com'
        ...
        '-m pip something --index-url http://user:pass@some-url.com --extra-index-url http://user2:pass2@another-url.com'           | '-m pip something --index-url http://user:*****@some-url.com --extra-index-url http://user2:*****@another-url.com'
